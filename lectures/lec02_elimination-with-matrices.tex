...
\onlyinsubfile{\begin{multicols*}{4}}
        ...
        \sectionboxnew{
            ...
            Elimination matrices refer to a set of matrices that are pre-multiplied to the coefficient matrix or the augmented matrix to produce the upper-triangular matrix \bm{U}. \\

            So, the elimination steps shown in the \textit{normal success example} compactly can also be expressed explicitly using elimination matrices:
        ...
        \sectionboxnew{
            ...
            Permutation matrices ($P$), are a group of square matrices obtained by exchanging either the rows or the columns of an \textit{identity matrix}. In matrix operations, these matrices are used for swapping rows or/and columns of a matrix.

            \begin{tabular}{@{}ll@{}}\trule
                \textrm{Task} & \textrm{Execution}         \\ \mrule
                \makecell[tl]{Swap rows,
                    $\begin{gmatrix}[b]
                            a & b \\
                            c & d
                            \rowops
